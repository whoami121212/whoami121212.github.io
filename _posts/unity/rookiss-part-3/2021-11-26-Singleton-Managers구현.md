...
- manager instance 호출
    -> get() method 실행
    -> init()을 통해서 'managers GameObject 생성' or 'Managers GameObject를 할당'
    -> Managers.s_Instance에 Managers component 할당
    -> return s_Instance, 즉 Managers 오브젝트의 Managers 컴포넌트의 Instance를 전달함. 