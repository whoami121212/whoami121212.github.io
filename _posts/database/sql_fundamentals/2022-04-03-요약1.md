...
- cross join(Cartesian Product Join) : 조인 컬럼없이 두 테이블 간 가능한 모든 연결을 결합하는 조인 방식<br>
아 이거 리사이징 어떻게 하는거야 왜 안돼ㅡㅡ 배워야겠네 


![image](https://user-images.githubusercontent.com/53845159/161434318-d9e5683f-6815-4e2e-bd4a-96895ddbb25c.png){: width="50%" height="50%"}{: .align-center}
